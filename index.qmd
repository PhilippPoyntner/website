...
::: {#hero-heading}
I am a Post Doc at the <a href="https://www.plus.ac.at/economics/?lang=en"> Department of Economics of the Paris Lodron University Salzburg </a>. Currently, I am visiting LIS / LISER as part of the <a href="https://www.lisdatacenter.org/projects/lis2er-initiative/visitors/"> (LIS)^2^ER visiting fellowship programme</a>.

My research interests include macroeconomics, specifically unconventional monetary policy, the housing market and inequality. I apply empirical methods using predominantly microdata such as surveys, firm data, bond data and administrative data.
...
Unconventional Monetary Policy and the Labour Share (with <a href="https://www.wu.ac.at/economics/mitarbeiter-innen/lea-steininger-1/"> Lea Steininger</a>, WU)

## Teaching

Einführung in die Statistische Datenanalyse (Introduction to statistical data analysis, 24S500110, Bachelor, PLUS)

Makroökonomik (Macroeconomics, 23W500052, Bachelor, PLUS)
...
Workshop at the University of Vienna (Department of Economic History): Development of a Python code to automatically web-scrape large-scale OCR-scans of historical documents, introduction of the code to the research team
